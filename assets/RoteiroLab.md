...
Você vai criar um agente que não apenas responde, mas que antecipa necessidades. Que personaliza sugestões com base no perfil de cada cliente. Que ajuda a tomar decisões financeiras de forma consultiva e orienta sobre economia. E, muito importante: que evita alucinações — ou seja, não inventa informações.
